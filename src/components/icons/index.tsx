...
export const IconeSol = (tamanho = 6) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-${tamanho} h-${tamanho}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const IconeGoogle = (tamanho = 6) => (
  <svg viewBox="0 0 128 128" className={`h-${tamanho} h-${tamanho}`}>
